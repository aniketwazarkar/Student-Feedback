...
image2 = image2.resize((1300, 700), Image.ANTIALIAS)
...
#
label_l1 = tk.Label(root, text="Student Feedback Using Machine Learning Algorithms",font=("Stencil Std", 35, 'bold'),
...
button1 = tk.Button(root, text="Login", command=log, width=12, height=1,font=('times', 20, ' bold '), bg="#45458B", fg="white")
button1.place(x=80, y=160)

button2 = tk.Button(root, text="Register",command=reg,width=12, height=1,font=('times', 20, ' bold '), bg="#45458B", fg="white")
