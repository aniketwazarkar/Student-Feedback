...
#
label_l1 = tk.Label(root, text="Student Feedback Using Machine Learning Algorithms",font=("Times New Roman", 35, 'bold'),
                    background="Maroon", fg="black", width=60, height=1)
